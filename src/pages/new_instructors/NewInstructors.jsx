...
const NewInstructors = () => {
    const cards = [
  {
    ...
    profile: ["Là cựu học sinh chuyên Anh - Trường THPT chuyên Phan Bội Châu", 
  ...
  },
  {
    ...
    profile: ["Chuyên gia với 25 năm kinh nghiệm, giảng dạy full-time tại 2G Education hơn 4 năm.",
    ...
    pov: ["Looking back six years ago when I first set foot in 2G, I feel truly happy to have contributed to its journey — from a small center in To Ngoc Van Alley, Vinh City, to now a growing education ecosystem, and then opening an official IELTS test center in Ho Chi Minh City.", 
  ...
  },
  {
  ...
  },
   {
    ...
    profile: ["4 năm kinh nghiệm làm việc tại Tập đoàn viễn thông quân đội Viettel",
  ...
  },
  {
    ...
    profile: ["Chức vụ: Trưởng phòng vận hành và dịch vụ CSKH chi nhánh  NA",
  ...
  },
  {
    ...
    profile: [" Giám đốc chi nhánh Nghệ An kiêm Giám đốc tài chính",
         "Có nhiều kinh nghiệm làm ở những tập đoàn có quy mô nhân sự lớn",
          "Liên tục đạt danh hiệu quản lý xuất sắc tại 2G",],
    pov: ["Với tôi, giáo dục không chỉ là việc dạy và học, mà là hành trình cùng nhau trưởng thành.",
  ...
  },
  {
    ...
    profile: ["Cử nhân tiếng Anh Thương Mại ĐH Thương Mại",
  ...
  },
  {
    ...
    profile: ["Th.s Quản lý giáo dục - ĐHQGHN",
         "Gần 15 năm kinh nghiệm trong lĩnh vực giáo dục",
          "Từng là CEO & Fouder Hệ thống giáo dục Starlink",],
    pov: ["Đối với tôi giáo dục vừa là đam mê, vừa là sứ mệnh, là hành trình khai phá những giới hạn của bản thân mỗi người. Tôi đến 2G với những cơ duyên đầy bất ngờ, nhưng những trải nghiệm ở đây về giáo dục 'sự tử tế' và  'sự thật' khiến tôi tin rằng tôi tìm được một mảnh ghép hoàn hảo cho con đường tôi đã chọn!",
    ],
  },
   {
    id: 9,
    ...
    profile: ["Nghiên cứu sinh Tiến sĩ về Quản trị Kinh doanh tại Đại học Gloucestershire",
    ...
    pov: ["Là một giảng viên đại học và nghiên cứu sinh tiến sĩ, tôi từng có nhiều cơ hội làm việc trong các môi trường học thuật, và với tôi giáo dục không chỉ là kiến thức, mà còn là sự tử tế, là mong muốn nâng đỡ những hành trình cá nhân bằng tất cả sự chân thành. Quan điểm này cũng tương đồng với quan điểm giáo dục mà 2G đang theo đuổi, và đó cũng chính là một trong những lý do khiến tôi mong muốn gắn bó lâu dài với 2G.",
  ...
  },
   {
    ...
    profile: ["Tốt nghiệp cử nhân khoa kinh tế",
    ...
    pov: ["Giáo dục là hành trình đánh thức tư duy, khai mở nhân cách, và nuôi dưỡng giá trị sống.",
  ...
  },
  {
    ...
    profile: ["Sở hữu hơn 6 năm kinh nghiệm Quản lý vận hành các hệ thống Anh ngữ lớn trên toàn quốc",
  ...
  },
  {
    ...
    profile: ["Tốt nghiệp chuyên ngành sư phạm, Đại học Vinh",
  ...
  },
   {
    ...
    profile: ["Tốt nghiệp loại giỏi ngành Sư Phạm Anh",
    ...
    pov: ["'Education is not the filling of a pail, but the lighting of a fire.' – William Butler Yeats.",
...

  {
    ...
    profile: ["Tốt nghiệp cử nhân ngành Kinh tế quốc tế, Học viện Ngoại giao Việt Nam.",
...

   {
    ...
    position: "Giáo viên IELTS & Aptis",
    profile: ["Tốt nghiệp loại giỏi chuyên ngành quản trị kinh doanh tại trường Wisconsin  International University in Ukraine.",
...

  {
    ...
    profile: ["Tốt nghiệp Học viện Bưu chính Viễn thông",
...

  {
    ...
    pov: ["Giáo dục là lĩnh vực càng làm càng muốn dấn thân. Tôi tin vào sức mạnh chuyển hóa của nó với sự trưởng thành mỗi con người. Tại 2G, triết lý ‘thực làm – thực tạo giá trị’ thôi thúc tôi hành động mỗi ngày, để giá trị thật được tạo ra, không chỉ được nói ra.",
    ],
  },

  {
    ...
    profile: ["Hơn 10 năm kinh nghiệm trong lĩnh vực Đào tạo và phát triển năng lực đội ngũ và 350h khia vấn trên nền tảng thông minh cảm xúc",
    ...
    pov: ["Làm việc tại 2G Education giúp tôi cảm nhận rõ tầm quan trọng của văn hoá doanh nghiệp tác động đến sự phát triển của doanh nghiệp như thế nào. Đặc biệt nhờ có 2 giá trị Resilience và Credibility, mỗi thành viên tại 2G Signature Campus giữ được sự kiên định vào mục tiêu làm giáo dục tử tế và từng bước mang tinh thần thực học vào trong từng hoạt động khảo thí và đào tạo ngoại ngữ.",
    ],
  },

  {
    ...
    profile: ["Tốt nghiệp loại giỏi trường Đại học Kinh tế Quốc Dân",
...

  {
    ...
    profile: ["Sở hữu hơn 6 năm kinh nghiệm làm việc trong ngành MKT, và hơn 5 năm kinh nghiệm trong MKT tuyển sinh tại hệ thống Giáo dục lớn.",
...

  {
    ...
    profile: ["Hơn 10 năm kinh nghiệm trong lĩnh vực dịch vụ",
         "Cử nhân Trường Đại học Vinh",
    ],
    pov: ["Trước khi gia nhập 2G, tôi biết đây là một trung tâm tiếng Anh nổi tiếng tại Nghệ An, đặc biệt trong lĩnh vực đào tạo IELTS. Tuy nhiên, khi bắt đầu làm việc tại đây, tôi mới thật sự nhận ra rằng 2G không chỉ là một trung tâm ngoại ngữ, mà là một tổ chức giáo dục có tầm nhìn rõ ràng, làm việc bằng sự tử tế và đầy tâm huyết. ",
...

  {
    ...
    return (
        <><Navbar /><div className="instructors_container">
            <h1 className="instructors_header">2G Humans</h1>
            <div className="instructors_showdow_list" >
            <FlipCard cards={cards} />
            </div>
            {/* <div className="instructors_showdow_list">
        <div className="instructor_flip_card">
            <img src="assets/humans-images/Alex.jpg" alt="" />
        </div>
         <div className="instructor_flip_card">
            <img src="assets/humans-images/Alex.jpg" alt="" />
        </div>
         ...
         <div className="instructor_flip_card">
            <img src="assets/humans-images/Emily.jpg" alt="" />
        </div>
         <div className="instructor_flip_card">
            <img src="assets/humans-images/Alex.jpg" alt="" />
        </div>
         <div className="instructor_flip_card">
            <img src="assets/humans-images/Kenzie.jpg" alt="" />
        </div>
        <div className="instructor_flip_card">
            <img src="assets/humans-images/Alex.jpg" alt="" />
        </div>
